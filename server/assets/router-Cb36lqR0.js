...
const appCss = "/assets/styles-Cf2FOX2O.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Atlas Systems — Full Stack, Cloud & Security Engineer" },
      {
        name: "description",
        content: "Senior Full Stack Engineer specializing in DevOps, cloud infrastructure, AI systems, and cybersecurity."
      },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Atlas Systems — Full Stack, Cloud & Security Engineer" },
      { name: "twitter:title", content: "Atlas Systems — Full Stack, Cloud & Security Engineer" },
      { name: "description", content: "A futuristic portfolio website showcasing a Full Stack Developer's expertise in software engineering, DevOps, cloud, AI, and cybersecurity." },
      { property: "og:description", content: "A futuristic portfolio website showcasing a Full Stack Developer's expertise in software engineering, DevOps, cloud, AI, and cybersecurity." },
      { name: "twitter:description", content: "A futuristic portfolio website showcasing a Full Stack Developer's expertise in software engineering, DevOps, cloud, AI, and cybersecurity." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6c78ea6f-6c16-49d0-920e-fd5ee5bf1d5e/id-preview-90c5ef1f--98da137f-a08a-4622-803b-6cb644b78cf2.lovable.app-1779367194624.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6c78ea6f-6c16-49d0-920e-fd5ee5bf1d5e/id-preview-90c5ef1f--98da137f-a08a-4622-803b-6cb644b78cf2.lovable.app-1779367194624.png" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Sans:wght@500;600;700&family=Public+Sans:wght@400;500;600&family=JetBrains+Mono:wght@400;500&display=swap"
      }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-u1BL8S3n.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Bashir Aliyu — Full Stack & DevOps engineer building production-grade web platforms, CI/CD pipelines, and secure cloud infrastructure."
    }, {
      property: "og:title",
      content: "Bashir Aliyu — Full Stack & DevOps Engineer"
    }, {
      property: "og:description",
      content: "Full-stack engineering, shipped end-to-end. Web, APIs, cloud infrastructure, and CI/CD."
    }, {
      property: "og:type",
      content: "website"
    }]
