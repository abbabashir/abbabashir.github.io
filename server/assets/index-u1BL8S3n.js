import { P as reactExports, H as jsxRuntimeExports } from "./server-Bal2xP1h.js";
...
function SiteNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.nav,
    {
      ...
      className: `fixed top-0 z-50 w-full transition-colors duration-300 ${scrolled ? "glass-panel border-b border-border/60" : "bg-transparent"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#top", className: "flex items-center gap-2.5 group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative grid size-7 place-items-center rounded-md bg-foreground text-background font-mono font-bold text-[11px]", children: [
            "BA",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-1 rounded-lg bg-brand-primary/30 blur-md opacity-0 group-hover:opacity-100 transition-opacity" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-sm font-semibold tracking-tight text-foreground", children: [
            "bashir",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-primary", children: "." }),
            "dev"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-8 text-sm font-medium md:flex", children: [
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            "aria-hidden": true,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 size-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-brand-primary/10 animate-orbit-slow" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 size-[680px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-brand-secondary/15 animate-orbit-med" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 size-[460px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-foreground/10 animate-orbit-fast" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 size-[900px] -translate-x-1/2 -translate-y-1/2 animate-orbit-slow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 size-2 rounded-full bg-brand-primary shadow-[0_0_20px_var(--brand-primary)]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 size-[680px] -translate-x-1/2 -translate-y-1/2 animate-orbit-med", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 size-1.5 rounded-full bg-brand-secondary shadow-[0_0_16px_var(--brand-secondary)]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 size-40 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-br from-brand-primary/30 via-brand-secondary/20 to-transparent blur-3xl" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { style: { y: yContent, opacity }, className: "relative z-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-1.5 animate-pulse rounded-full bg-brand-primary" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "shipped end-to-end" }),
                "."
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-primary", children: "$" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "bashir" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/60", children: "deploy" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-tertiary", children: "--stack=fullstack" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-secondary", children: "--ops=prod" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 inline-block size-1.5 animate-pulse rounded-sm bg-brand-primary" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.p,
            {
              ...
              children: [
                "I'm ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Bashir Aliyu" }),
                " — a Full Stack & DevOps engineer building production-grade web platforms, CI/CD pipelines, and secure cloud infrastructure that ships reliably to real users."
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: stats$1.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold tracking-wider text-muted-foreground uppercase", children: s.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-display text-2xl font-semibold text-foreground", children: s.value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-px rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-br from-brand-primary/10 to-transparent pointer-events-none" })
                ]
              },
              s.label
            ))
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-16 md:grid-cols-[1fr_1.4fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:sticky md:top-32 self-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-brand-primary mb-4", children: "01 / Origin" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-semibold tracking-tight text-foreground", children: "A practitioner across the full stack — silicon to interface." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 h-px w-24 bg-gradient-to-r from-brand-primary to-transparent" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-7", children: paragraphs.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.p,
      {
        initial: { opacity: 0, y: 16 },
...
function Expertise() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "expertise", className: "relative py-32 px-6 bg-surface/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16 flex flex-col gap-6 md:flex-row md:items-end md:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-brand-primary mb-4", children: "02 / Core Directives" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-semibold tracking-tight text-foreground", children: "Specializations across the modern engineering stack." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-pretty text-muted-foreground", children: "Seven disciplines I practice deeply — combined into systems that are fast, secure, and built to last." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3", children: items$1.map((it, i) => {
      const Icon2 = it.icon;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mb-6 inline-flex size-11 items-center justify-center rounded-xl ${accentMap[it.accent]}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "size-5", strokeWidth: 1.6 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-medium text-foreground", children: it.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-muted-foreground", children: it.body })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-8 h-px w-full bg-border transition-colors ${lineMap[it.accent]}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pointer-events-none absolute -inset-px rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-br from-brand-primary/[0.06] to-transparent" })
          ]
        },
        it.title
      );
...
const apexCollabImg = "/assets/project-apex-collab-C7n0r226.jpg";
const sentinelNexusImg = "/assets/project-sentinel-nexus-DIBRgudl.jpg";
const secureFlowImg = "/assets/project-secure-flow-4XcrmW-2.jpg";
const aetherOpsImg = "/assets/project-aetherops-ai-DsqYbOxN.jpg";
const autonomousOpsImg = "/assets/project-autonomous-ops-Lnj-w6M5.jpg";
const cloudweaveImg = "/assets/project-cloudweave-U0X6172b.jpg";
const projects = [
  {
    tag: "Realtime Collab",
    title: "Apex Collab",
...
function ProjectArt({ image, title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] w-full overflow-hidden rounded-xl bg-background outline outline-1 -outline-offset-1 outline-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: image,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-3 left-4 font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground", children: title })
  ] });
}
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "projects", className: "relative overflow-hidden py-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-brand-primary mb-4", children: "03 / Active Deployments" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-semibold tracking-tight text-foreground", children: "Selected systems shipped to production." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-pretty text-muted-foreground", children: "Case studies across security, AI orchestration, and large-scale cloud infrastructure." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-6 overflow-x-auto px-6 lg:px-[max(24px,calc((100vw-1280px)/2))] pb-12 scrollbar-hide snap-x snap-mandatory", children: projects.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.article,
      {
        initial: { opacity: 0, y: 30 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectArt, { image: p.image, title: p.title })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-[10px] font-semibold tracking-wider uppercase ${p.accent}`, children: p.tag }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-2 font-display text-2xl font-medium text-foreground", children: p.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-muted-foreground", children: p.body }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex flex-wrap gap-2", children: p.stack.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: p.href,
                target: "_blank",
...
function Experience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "relative py-32 px-6 bg-surface/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-brand-primary mb-4", children: "04 / Trajectory" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-semibold tracking-tight text-foreground", children: "Experience & leadership." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "relative border-l border-border pl-8", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.li,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute -left-[37px] top-1.5 grid size-4 place-items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full bg-brand-primary/20 animate-ping" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative size-2.5 rounded-full bg-brand-primary shadow-[0_0_16px_var(--brand-primary)]" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-brand-primary mb-2", children: it.year }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-foreground", children: it.role }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider text-muted-foreground mt-1", children: it.org }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground", children: it.body })
        ]
      },
      it.role
    )) })
...
function TechStack() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "stack", className: "relative py-32 px-6 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl grid gap-16 lg:grid-cols-[1.1fr_1fr] items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-brand-primary mb-4", children: "05 / Tooling" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-semibold tracking-tight text-foreground", children: "The technologies I deploy daily." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-lg text-muted-foreground", children: "A working stack tuned for performance, security, and engineering velocity — chosen for fit, not fashion." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 space-y-6", children: groups.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 12 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-brand-primary mb-3", children: g.label }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square w-full max-w-[560px] mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-[8%] rounded-full border border-border" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-[20%] rounded-full border border-border" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-[36%] rounded-full border border-border" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 grid size-24 place-items-center rounded-full bg-gradient-to-br from-brand-primary/30 to-brand-secondary/20 backdrop-blur-md border border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground", children: "Core" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full blur-2xl bg-brand-primary/30" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-orbit-slow", children: orbital.map((t, i) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-[20%] animate-orbit-fast", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 size-2 rounded-full bg-brand-secondary shadow-[0_0_14px_var(--brand-secondary)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 size-2 rounded-full bg-brand-primary shadow-[0_0_14px_var(--brand-primary)]" })
      ] })
    ] })
  ] }) });
}
...
function Community() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-32 px-6 bg-surface/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16 max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-brand-primary mb-4", children: "06 / Impact" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-semibold tracking-tight text-foreground", children: "Community, mentorship, and developer growth." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-px bg-border border border-border rounded-2xl overflow-hidden mb-16 md:grid-cols-4", children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 12 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-3xl font-semibold text-foreground", children: s.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-[10px] font-semibold tracking-wider uppercase text-muted-foreground", children: s.label })
        ]
      },
      s.label
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-3", children: highlights.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 16 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-medium text-foreground", children: h.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-muted-foreground", children: h.body })
        ]
      },
      h.title
    )) })
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "relative py-32 px-6 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 mesh-bg opacity-60 pointer-events-none", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-3xl text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-brand-primary mb-4", children: "07 / Initiate Handshake" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-5xl font-semibold tracking-tight text-foreground", children: "Let's build the future." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-muted-foreground max-w-xl mx-auto", children: "I'm always open to collaborating on innovative projects, scalable systems, and impact-driven technology solutions." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.form,
        {
          initial: { opacity: 0, y: 16 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: "Message" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  required: true,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex flex-wrap justify-center gap-6 text-sm", children: [
...
function Field({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        required: true,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border py-12 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 sm:flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-4 rounded-sm bg-gradient-to-br from-brand-primary to-brand-secondary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] font-semibold tracking-[0.2em] uppercase text-muted-foreground", children: [
        "Bashir Aliyu © ",
        (/* @__PURE__ */ new Date()).getFullYear()
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/abbabashir", target: "_blank", rel: "noopener noreferrer", className: "font-mono text-[10px] font-semibold tracking-widest uppercase text-muted-foreground transition-colors hover:text-brand-primary", children: "GitHub" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://linkedin.com/in/abbabashir", target: "_blank", rel: "noopener noreferrer", className: "font-mono text-[10px] font-semibold tracking-widest uppercase text-muted-foreground transition-colors hover:text-brand-primary", children: "LinkedIn" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "text-[10px] font-semibold tracking-widest uppercase text-muted-foreground transition-colors hover:text-brand-primary", children: "Contact" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "#top",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUp, { className: "size-4 text-muted-foreground group-hover:text-brand-primary transition-colors" })
        }
      )
    ] })
  ] }) });
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative size-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full border border-brand-primary/30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.span,
            {
              animate: { rotate: 360 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-3 rounded-full bg-gradient-to-br from-brand-primary/30 to-brand-secondary/30 blur-md" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
